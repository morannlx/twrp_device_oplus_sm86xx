...
log_print 1 "prepdecrypt.sh: Script started."
umount -f -l /system
log_print 1 "prepdecrypt.sh: /system unmounted."
umount -f -l /vendor
log_print 1 "prepdecrypt.sh: /vendor unmounted."
umount -f -l /odm
log_print 1 "prepdecrypt.sh: /odm unmounted."
